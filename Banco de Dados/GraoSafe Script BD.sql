...
idCliente INT NOT NULL,  -- Não é unique porque uma empresa pode ter vários silos e/ou vários equipamentos (fkCliente)
dtInstalacao  DATETIME,  
idSensor INT NOT NULL); -- fkSensor e fkTemperatura
